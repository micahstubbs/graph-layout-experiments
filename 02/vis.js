...
const graph = {
  nodes: [
    { id: 0, size: 10, type: 'alpha' },
    { id: 1, size: 5, type: 'beta' },
    { id: 2, size: 2, type: 'beta' },
    { id: 3, size: 3, type: 'gamma' },
    { id: 4, size: 30, type: 'delta' },
    { id: 5, size: 40, type: 'delta' }
  ],
  links: [
    { source: 0, target: 1 },
    { source: 0, target: 2 },
